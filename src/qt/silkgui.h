...
#ifndef SILK_QT_SILKGUI_H
#define SILK_QT_SILKGUI_H
...
// Silk : to ensure that we can click on lock icon in GUI
...
/**
  Silk GUI main class. This class represents the main window of the silk UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SilkGUI : public QMainWindow
{
    Q_OBJECT
...
#endif // ENABLE_WALLET
    bool enableWallet;
    ClickableLockLabel *labelEncryptionIcon; // Silk: changed from private to public
